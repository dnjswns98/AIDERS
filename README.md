...
| **Infra**<br/>AWS EC2<br/>Docker<br/>Nginx<br/>SSL<br/>**Backend**<br/>Spring Boot<br/>MySQL<br/>Redis | **Backend**<br/>Spring Boot<br/>Spring Data JPA<br/>QueryDSL<br/>MySQL<br/>API 설계 | **Backend**<br/>Spring Boot<br/>Spring Data JPA<br/>QueryDSL<br/>MySQL<br/>Spring AI<br/>병원 추천 알고리즘<br/>알람(WebSocket)<br/>OpenVidu<br/>Redis | **Frontend**<br/>React 18<br/>TailwindCSS<br/>WebRTC<br/>OpenVidu<br/>사용자 UI/UX<br/>실시간 통신 | **Frontend**<br/>React 18<br/>TailwindCSS<br/>WebRTC<br/>OpenVidu<br/>사용자 UI/UX<br/>컴포넌트 설계 | **AI/OCR**<br/>PyTorch<br/>ONNX Runtime<br/>OpenCV<br/>CRNN 모델<br/>온디바이스 처리<br/>AI 모델 최적화 |
